...
- To build the demo directly from the source code, see the [Influent repository](https://github.com/cogpy/influent/tree/master/influent-app/) on GitHub. Intended for web developers only. <p class="list-paragraph"><strong>NOTE</strong>: Additional example applications utilizing <a href="https://github.com/cogpy/influent/tree/master/bitcoin/">Bitcoin</a>, <a href="https://github.com/cogpy/influent/tree/master/kiva/">Kiva</a> and <a href="https://github.com/cogpy/influent/tree/master/walker/">email</a> transactions are also available in this repository. As with the generic financial application, these demonstrations are intended for web developers only.</p>
