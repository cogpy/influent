...
![Influent example with public Kiva data set](https://raw.github.com/cogpy/wiki-assets/master/influent/influent-kiva.png)
...
Documentation on installing, configuring and using Influent is available in the [docs folder](https://github.com/cogpy/influent/tree/master/docs/src/) in the source code.
...
- Review the [Release Notes](https://github.com/cogpy/influent/blob/master/RELEASE_NOTES.md) to see what's new.
...
- Examine the configuration of the example applications provided with the source code:
	- [Bitcoin](https://github.com/cogpy/influent/tree/master/bitcoin/)
	- [Influent App](https://github.com/cogpy/influent/tree/master/influent-app/)
	- [Kiva](https://github.com/cogpy/influent/tree/master/kiva/)
	- [Walker](https://github.com/cogpy/influent/tree/master/walker/)
...
For support questions, technical suggestions and contributions, please post your feedback to the [GitHub Issues forum](https://github.com/cogpy/influent/issues) for this project.
